                    ...
                    <div className='flex flex-col lg:flex-row  gap-8'>
                        ...
                        <div className='w-full'>
                            ...
                            <div>
                                ...
                                <input type='text' required {...register("userName")} placeholder='Ex: John Doe' className='create-job-input placeholder:text-xs md:placeholder:text-sm'></input>
                            </div>
                            <div>
                                <label className='block mt-2 m-1 text-sm'>Email</label>
                                <input type='email' required {...register("userEmail")} placeholder='Ex: example@site.com' className='create-job-input placeholder:text-xs md:placeholder:text-sm'></input>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type='text' required {...register("address")} placeholder='Add Complete Address' className='create-job-input placeholder:text-xs md:placeholder:text-sm'></input>
                            </div>
                            <div>
